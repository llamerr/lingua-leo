...
import { DeleteGuestbookEntry } from '@/components/Guestbook/DeleteGuestbookEntry';
import { EditableGuestbookEntry } from '@/components/Guestbook/EditableGuestbookEntry';
      ...
      <div className="mt-5">
        {guestbook.map((elt) => (
          <div key={elt.id} className="mb-1 flex items-center gap-x-1">
            ...
            <EditableGuestbookEntry id={elt.id} username={elt.username} body={elt.body} />
          </div>
        ))}
      </div>
